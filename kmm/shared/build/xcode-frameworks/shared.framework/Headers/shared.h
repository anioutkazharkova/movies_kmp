...
@protocol SharedIMoviesListView
@required
- (void)setupItemsItems:(NSArray<SharedMovieItem *> *)items __attribute__((swift_name("setupItems(items:)")));
@end;

__attribute__((swift_name("IMoviesPresenter")))
@protocol SharedIMoviesPresenter
@required
- (void)attachViewView:(id<SharedIMoviesListView>)view __attribute__((swift_name("attachView(view:)")));
- (void)detachView __attribute__((swift_name("detachView()")));
- (void)loadMovies __attribute__((swift_name("loadMovies()")));
@property id<SharedIMoviesListView> _Nullable view __attribute__((swift_name("view")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MoviesPresenter")))
@interface SharedMoviesPresenter : SharedBase <SharedIMoviesPresenter>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)attachViewView:(id<SharedIMoviesListView>)view __attribute__((swift_name("attachView(view:)")));
- (void)detachView __attribute__((swift_name("detachView()")));
...
@interface SharedMoviesService : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)loadMoviesWithCompletionHandler:(void (^)(SharedMoviesList * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("loadMovies(completionHandler:)")));
@property (readonly) SharedNetworkService *networkService __attribute__((swift_name("networkService")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)loadDataUrl:(NSString *)url completionHandler:(void (^)(id _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("loadData(url:completionHandler:)")));
@property (readonly) SharedKtor_client_coreHttpClient *httpClient __attribute__((swift_name("httpClient")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MovieItem")))
@interface SharedMovieItem : SharedBase
- (instancetype)initWithId:(int32_t)id title:(NSString *)title overview:(NSString *)overview releaseData:(NSString *)releaseData posterPath:(NSString *)posterPath __attribute__((swift_name("init(id:title:overview:releaseData:posterPath:)"))) __attribute__((objc_designated_initializer));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (NSString *)component5 __attribute__((swift_name("component5()")));
- (SharedMovieItem *)doCopyId:(int32_t)id title:(NSString *)title overview:(NSString *)overview releaseData:(NSString *)releaseData posterPath:(NSString *)posterPath __attribute__((swift_name("doCopy(id:title:overview:releaseData:posterPath:)")));
...
@property NSString *overview __attribute__((swift_name("overview")));
@property NSString *posterPath __attribute__((swift_name("posterPath")));
@property NSString *releaseData __attribute__((swift_name("releaseData")));
@property NSString *title __attribute__((swift_name("title")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MovieItem.Companion")))
@interface SharedMovieItemCompanion : SharedBase
...
@interface SharedMoviesList : SharedBase
- (instancetype)initWithResults:(NSArray<SharedMovieItem *> *)results __attribute__((swift_name("init(results:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedMovieItem *> *)component1 __attribute__((swift_name("component1()")));
- (SharedMoviesList *)doCopyResults:(NSArray<SharedMovieItem *> *)results __attribute__((swift_name("doCopy(results:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSArray<SharedMovieItem *> *results __attribute__((swift_name("results")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MoviesList.Companion")))
@interface SharedMoviesListCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
